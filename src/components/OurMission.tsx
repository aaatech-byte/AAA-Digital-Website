        ...
        <div className="mx-auto max-w-7xl">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
            <div className="relative text-center z-30">
              ...
              <p className="text-base md:text-lg font-semibold text-gray-600 my-5 pb-5 max-w-3xl mx-auto">
            ...
            <div className="absolute -bottom-72 sm:-bottom-28 xl:-bottom-44">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 lg:gap-4 lg:pr-0 pr-6">
                {heroData.features.map((feature, index) => (
                  <div
                    key={index}
                    className="bg-gray-50 scale-100 hover:scale-105 duration-300 p-2 md:p-3 lg:p-5 rounded-lg shadow-md hover:shadow-xl"
                    // style={{
