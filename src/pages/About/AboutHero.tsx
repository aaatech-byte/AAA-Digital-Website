...
const AboutHero = () => {
  return (
    <>
      <section className="relative h-[90vh]  pt-20 bg-[url('https://thumbs.wbm.im/pw/medium/34950f1f017647cd3f8484485b040686.avif')] bg-cover bg-center">
      <div className="absolute bg-gray-100 z-10 w-[100%] h-[88%] opacity-80"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-40 text-center z-30">
            ...
            <p className="text-lg text-gray-700 mb-8 mt-10 max-w-5xl mx-auto">
